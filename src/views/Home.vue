          ...
          <main class="mb-auto">
            <div class="divide-y divide-gray-200 dark:divide-gray-700">
              <div class="pt-6 pb-8 space-y-2 md:space-y-5">
                ...
                <p class="text-lg leading-7 text-gray-500 dark:text-gray-400">I'm always looking for work! If you're interested in recieving a copy of my resume, you can email me <a href="mailto:brandonmsaldan@gmail.com" style="display: inline">here</a>, or get in touch with me on <a href="https://linkedin.com/brandonsaldan/" style="display: inline">LinkedIn.</a></p>
              </div>
            </div>
          </main>
        </div>

          ...
          <main class="mb-auto">
            <div class="divide-y divide-gray-200 dark:divide-gray-700 animate__animated animate__fadeIn">
              <div class="pt-6 pb-8 space-y-2 md:space-y-5">
                ...
                <p class="text-lg leading-7 text-gray-500 dark:text-gray-400">My name is <a>Brandon Saldan</a>. I'm a business and computer science student from Pennsylvania.<br>I'm a freshman in college majoring in business administration with plans to finish my bachelor's degree in management information systems and (hopefully) complete an MBA.</p>
